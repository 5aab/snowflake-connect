...
import static com.example.cqrs.app.domain.vehicle.VehicleQueryFilter.*;
...
public class PipelinerController {
   ...
   // @ResponseBody
    ...
    public Set<VehicleRecord> searchVehicle(@QuerydslPredicate(root = Vehicle.class) Predicate predicate) {
